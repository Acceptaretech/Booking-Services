                            ...
                            <div class="flex items-start gap-4">
                                ...
                                <form method="POST"
                                    ...
                                    <button type="submit"
                                            ...
                                            {{ $address->is_default ? 'bg-pink-100 text-pink-500' : 'bg-gray-100 text-gray-400' }}">
                        ...
                        <div id="editModal{{ $address->id }}"
                            ...
                            <div class="bg-white rounded-3xl max-w-xl w-full p-6">
                                ...
                                <div class="flex justify-between items-center mb-5">
                                    ...
                                    <button onclick="closeEditModal({{ $address->id }})" class="text-2xl">&times;</button>
                                </div>
                                ...
                                <form method="POST" action="{{ route('customer.addresses.update', $address) }}">
                                    ...
                                    @include('customer.addresses.partials.form', ['address' => $address])
...
<div id="addModal" class="hidden fixed inset-0 bg-black/50 z-50 items-center justify-center p-4">
    ...
    <div class="bg-white rounded-3xl max-w-xl w-full p-6">
        ...
        <form method="POST" action="{{ route('customer.addresses.store') }}">
            ...
            @include('customer.addresses.partials.form', ['address' => null])
