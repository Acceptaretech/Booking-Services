...
<div class="flex items-start gap-3 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 text-blue-700 dark:text-blue-300 px-4 py-3 rounded-xl mb-5 text-sm fade-in">
    ...
    <span>Important Notice: Please enable RazorpayX from <a href="<?php echo e(route('admin.settings.general')); ?>" class="font-semibold underline">PAYMENT CONFIGURATION</a> to allow providers to withdraw funds. <a href="<?php echo e(route('admin.settings.general')); ?>" class="underline font-medium ml-1">Here is the link ↗</a></span>
</div>
<?php endif; ?>
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\sales\Desktop\handyman\handyman\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>