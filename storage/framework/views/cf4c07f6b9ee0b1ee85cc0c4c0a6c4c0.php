<form
    ...
    <div class="grid grid-cols-2 gap-6">
        ...
        <div>
            ...
            <input
                type="text"
                name="company_name"
                value="<?php echo e($getConfig('company_name')); ?>"
    ...
    <div class="lg:col-span-2">
        ...
        <textarea
            ...
            rows="4"
            class="w-full border rounded-lg px-4 py-3"><?php echo e($getConfig('company_address')); ?></textarea>
    </div>
...
</form><?php /**PATH C:\Users\sales\Desktop\handyman\handyman\resources\views/admin/settings/tabs/general.blade.php ENDPATH**/ ?>