<?php $__env->startSection('title', 'Home - Your Instant Handyman Service'); ?>
    ...
    <div class="max-w-7xl mx-auto px-4 text-center">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
            <?php $__currentLoopData = [['fa-search','Search Service','Browse from hundreds of verified services in your area.'],
                      ...
                      ['fa-star','Get Service','Our expert handyman arrives and completes the job perfectly.']]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="relative">
                <?php if(!$loop->last): ?>
...
<?php echo $__env->make('layouts.public.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\sales\Desktop\handyman\handyman\resources\views/public/home/index.blade.php ENDPATH**/ ?>