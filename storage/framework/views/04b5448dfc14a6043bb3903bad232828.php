...
?>
    <?php if($favicon): ?>
        <link rel="icon" type="image/*" href="<?php echo e(asset('storage/'.$favicon)); ?>">
    <?php endif; ?>
        ...
        <div class="flex items-center justify-between h-16">
            ...
            <a href="<?php echo e(route('home')); ?>" class="flex items-center gap-2">
                <?php if($logo = \App\Models\SystemConfig::where('key','logo')->value('value')): ?>
                    <img src="<?php echo e(asset('storage/'.$logo)); ?>" alt="Logo" class="h-[63px] w-auto">
            ...
            <div>
                ...
                <div class="text-sm text-gray-400 mb-4">
                    <p>
                        ...
                        <?php echo e(\App\Models\SystemConfig::where('key','company_address')->value('value') ?? '123 Main Street, Your City, India'); ?>
...
<?php /**PATH C:\Users\sales\Desktop\handyman\handyman\resources\views/layouts/public/app.blade.php ENDPATH**/ ?>