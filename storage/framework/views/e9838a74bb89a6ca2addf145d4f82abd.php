...
<!DOCTYPE html>
<html lang="en" class="<?php echo e(session('theme','light')); ?>">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="csrf-token" content="<?php echo e(csrf_token()); ?>">

    <title>Sign In | <?php echo e(config('app.name','HandyMan')); ?></title>
    ...
    <div class="hidden lg:flex flex-col justify-center px-16">
        <div class="max-w-xl">
            ...
            <h1 class="text-5xl font-extrabold leading-tight mb-5">
                Welcome Back to <br>
                <span class="text-primary-400"><?php echo e(config('app.name','HandyMan')); ?></span>
            </h1>
        ...
        <div class="w-full max-w-md glass rounded-3xl p-8 shadow-2xl">
            ...
            <form method="POST" action="<?php echo e(route('login')); ?>">
                ...
                <div class="flex items-center justify-between mb-5">
                    ...
                    <a href="<?php echo e(route('password.request')); ?>" class="text-sm text-primary-300 hover:text-primary-200">
                        Forgot Password?
                    </a>
                </div>
                ...
                <p class="text-center text-slate-300 text-sm mt-5">
                    ...
                    <a href="<?php echo e(route('register')); ?>" class="text-primary-300 font-semibold hover:underline">
                        Sign Up
                    </a>
                </p>

                <p class="text-center mt-2">
                    <a href="<?php echo e(route('provider.register')); ?>" class="text-slate-400 text-xs hover:text-primary-300">
...
</html><?php /**PATH D:\Downloads\handyman-platform (1) (1)\handyman\resources\views/auth/login.blade.php ENDPATH**/ ?>