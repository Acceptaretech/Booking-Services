...
<?php $__env->startSection('page_title','Add New Handyman'); ?>
...
<div class="card p-6">
    ...
    <form method="POST"
          action="<?php echo e(route('admin.handymen.store')); ?>"
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-5">
            ...
            <div>
                ...
                <input name="first_name" value="<?php echo e(old('first_name')); ?>" required placeholder="First Name"
            ...
            <div>
                ...
                <input name="last_name" value="<?php echo e(old('last_name')); ?>" required placeholder="Last Name"
                       class="w-full border rounded px-5 py-4 bg-white dark:bg-gray-800">
            </div>

            <div>
                <label class="block mb-2">Username <span class="text-red-500">*</span></label>
                <input name="username" value="<?php echo e(old('username')); ?>" required placeholder="Username"
                       class="w-full border rounded px-5 py-4 bg-white dark:bg-gray-800">
            </div>
            ...
            <div>
                ...
                <select name="commission_type" required class="w-full border rounded px-5 py-4 bg-white dark:bg-gray-800">
                    <option value="percent" <?php echo e(old('commission_type') == 'percent' ? 'selected' : ''); ?>>Percent</option>
                    <option value="fixed" <?php echo e(old('commission_type') == 'fixed' ? 'selected' : ''); ?>>Fixed</option>
                </select>
            </div>

            <div>
                <label class="block mb-2">Commission <span class="text-red-500">*</span></label>
                <input type="number" step="0.01" name="commission" value="<?php echo e(old('commission')); ?>" required placeholder="Commission"
                       class="w-full border rounded px-5 py-4 bg-white dark:bg-gray-800">
            </div>
        ...
        <div class="mb-5">
            ...
            <textarea name="address" rows="4" placeholder="Address"
                      class="w-full border rounded px-5 py-4 bg-white dark:bg-gray-800"><?php echo e(old('address')); ?></textarea>
        </div>

        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            <div>
                <label class="block mb-2">Select Country</label>
                <input name="country" value="<?php echo e(old('country')); ?>" placeholder="Select Country"
                       class="w-full border rounded px-5 py-4 bg-white dark:bg-gray-800">
            </div>

            <div>
                <label class="block mb-2">Select State</label>
                <input name="state" value="<?php echo e(old('state')); ?>" placeholder="Select State"
                       class="w-full border rounded px-5 py-4 bg-white dark:bg-gray-800">
            </div>

            <div>
                <label class="block mb-2">Select City</label>
                <input name="city" value="<?php echo e(old('city')); ?>" placeholder="Select City"
                       class="w-full border rounded px-5 py-4 bg-white dark:bg-gray-800">
            </div>
        </div>
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Downloads\handyman-platform (1) (1)\handyman\resources\views/admin/handymen/create.blade.php ENDPATH**/ ?>