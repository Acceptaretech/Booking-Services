...
<?php $__env->startSection('page_title','Provider Request List'); ?>
                    ...
                    <tr class="border-b dark:border-gray-700 odd:bg-gray-100 dark:odd:bg-gray-800">
                        <td class="p-4">
                            <div class="flex items-center gap-3">
                                <img src="<?php echo e($provider->image ? asset('storage/'.$provider->image) : asset('assets/admin/img/avatar.png')); ?>"
                                     class="w-11 h-11 rounded-full object-cover">

                                <div>
                                    <div class="font-bold text-gray-900 dark:text-white">
                                        <?php echo e($provider->first_name ?? $provider->name); ?>
                        ...
                        <td class="p-4 text-gray-700 dark:text-gray-300">
                            <?php echo e($provider->created_at ? $provider->created_at->format('F d, Y h:i A') : '-'); ?>

                        </td>

                        <td class="p-4 text-gray-700 dark:text-gray-300">
                            <?php echo e($provider->commission ?? '-'); ?>

                        </td>

                        <td class="p-4 text-gray-700 dark:text-gray-300">
                            <?php echo e($provider->phone ?? $provider->contact_number ?? '-'); ?>

                        </td>

                        <td class="p-4 font-bold">
                            <?php echo e($provider->shop_count ?? 0); ?>

                        </td>

                        <td class="p-4 font-bold">
                            $<?php echo e(number_format($provider->wallet_amount ?? 0, 2)); ?>
                        ...
                        <td class="p-4">
                            <div class="flex gap-3 items-center">
                                ...
                                <form method="POST" action="<?php echo e(route('admin.providers.reject', $provider->id)); ?>">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('PATCH'); ?>
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Downloads\handyman-platform (1) (1)\handyman\resources\views/admin/providers/requests.blade.php ENDPATH**/ ?>