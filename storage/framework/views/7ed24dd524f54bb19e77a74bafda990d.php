    ...
    <aside id="sidebar" class="bg-gray-950 flex flex-col overflow-hidden flex-shrink-0">
        ...
        <nav class="flex-1 overflow-y-auto py-2 px-2 space-y-0.5" id="sidebar-nav">
           ...
           <a href="<?php echo e(route('admin.payments.cash')); ?>"
            ...
            <a href="<?php echo e(route('admin.settings.index')); ?>" class="sb-link <?php echo e(request()->routeIs('admin.settings*') ? 'active' : ''); ?>">
                ...
                <div class="relative group ml-1">
                    ...
                    <div class="absolute right-0 top-11 w-52 bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all z-50 overflow-hidden">
                        ...
                        <div class="py-1">
                            ...
                            <a href="<?php echo e(Route::has('admin.settings.index') ? route('admin.settings.index') : '#'); ?>" class="flex items-center gap-2.5 px-4 py-2.5 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
...
</html><?php /**PATH D:\Downloads\handyman-platform (1) (1)\handyman\resources\views/layouts/admin/app.blade.php ENDPATH**/ ?>